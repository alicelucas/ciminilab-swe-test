  ...
  function () {
    ...
    g.getAbsoluteElPos = function (b) {
      ...
      do {
        c[0] += b.offsetTop;
        c[1] += b.offsetLeft
      } while (b = b.offsetParent); // eslint-disable-line no-cond-assign
      return c
    };
    ...
    g.tick = function () {
      var b = (new Date).getTime(); // eslint-disable-line new-parens
    ...
    g.initializeTickTimer = function () {
      ...
      g.lastTime = (new Date).getTime(); // eslint-disable-line new-parens
      g.lastTimeDelta = 0;
    ...
    g.preloadImage = function (b) {
      var c = new Image, // eslint-disable-line new-parens
    ...
    g.detectFlash = function () {
      var b = e, // eslint-disable-line no-unused-vars
        c = "";
